      ...
      <table class="table table-bordered table-striped">
        ...
        <td>
          <div class="formulacion" id="animacion">
            ...
            <p style="text-align: justify">
              <strong>       ¿Cómo enfrenta la 'Plataforma E-COMERCE Desarrollada con Flutter’ los
                ...
                actualizaciones tecnológicas constantes?</strong>
        ...
        <table class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <td>
              ...
              <img src="@/assets/img/tabla1.1.jpg" alt="tabla" class="img-fluid"/>
            </td>
          </tbody>
        </table>
      </div>
